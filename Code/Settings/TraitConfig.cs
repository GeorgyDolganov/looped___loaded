...
public class TraitConfig : GameResource
{
	...
	[Property] public TraitTiers LashTick { get; set; } = new() { Level1 = 0.6f, Level2 = 0.4f, Level3 = 0.2f };
	[Property] public TraitTiers LashTicks { get; set; } = new() { Level1 = 4f, Level2 = 6f, Level3 = 8f };
	[Property] public float LashReload { get; set; } = 0.30f;
	...
	[Property] public float SlapSpeed { get; set; } = 0.85f;
	[Property] public float RackReload { get; set; } = 0.75f;
	[Property] public float RackSpeed { get; set; } = 0.85f;
	[Property] public float DrawReload { get; set; } = 0.85f;
	[Property] public int DrawPierce { get; set; } = 1;
	[Property] public float FeedReload { get; set; } = 0.75f;
	[Property] public float FeedCycle { get; set; } = 1.20f;
	[Property] public float EjectReload { get; set; } = 0.85f;
	[Property] public int EjectBurst { get; set; } = 1;
	[Property] public float VentReload { get; set; } = 0.80f;
	[Property] public float VentTick { get; set; } = 1.20f;
	[Property] public float CoolReload { get; set; } = 0.85f;
	[Property] public float CoolWidth { get; set; } = 0.80f;
	[Property] public float ShuckReload { get; set; } = 0.80f;
	[Property] public float ShuckCone { get; set; } = 8f;
	[Property] public float SlamReload { get; set; } = 0.85f;
	[Property] public int SlamPellets { get; set; } = 1;
